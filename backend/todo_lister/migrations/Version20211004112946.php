 ...
 */
final class Version20211004112946 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE todo (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL COLLATE BINARY, realizada BOOLEAN NOT NULL, fecha_creacion DATETIME NOT NULL, fecha_tope DATETIME NOT NULL)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE todo');
        $this->addSql('CREATE TABLE todo (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, realizada BOOLEAN NOT NULL, fecha_creacion DATE NOT NULL, fecha_tope DATE NOT NULL)');
